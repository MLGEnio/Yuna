...
import loadCurrency from "../currency/data.js";
import InstagramData from "../instagram/data.js";
import BlogData from "../Blogs/data.js";
import _ from "lodash";
import ProductResponse from "./schema.js";
...
const resolvers = {
  ...
  Mutation: {
    signup: async (_, { username, email, password, confirmPassword }) => {
      try {
        console.log("User input:", username, email, password, confirmPassword);
        ...
        // Log the error to see what the actual issue is
        console.error("Error in signup mutation:", error);

        // Throw the exact error message instead of a generic one
